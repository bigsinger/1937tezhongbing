...
namespace Mission1937.SDK.Generated
{
    ...
    public static class M1937MissionRoutes
    {
        public static readonly M1937MissionRoute[] All =
        {
            ...
            new M1937MissionRoute(15, 7, "m014", "1937M014.VWF", true, 0x000CF4F8L, "1937M006.VWF", "破晓密令（全新合成地图）", "1944 年秋，平汉铁路东侧的青石镇成为日伪军封锁根据地交通线的临时中转站。武工队员强子从镇南秘密潜入，先与交通员在晨市接头，确认两名掌握封锁计划的关键人物；随后分别截获二人携带的口令和布防图，最后从镇东交通口撤离。", new[] { "在晨市与交通员接头。", "截获伪警备队口令与日军封锁布防图。", "携带情报从镇东秘密交通口撤离。" }, true),
        };

...
inline constexpr std::uintptr_t initialize_viewport = 0x0004A780;
inline constexpr std::uintptr_t set_camera_origin = 0x0004A870;
inline constexpr std::uintptr_t scroll_left = 0x0004A930;
inline constexpr std::uintptr_t scroll_right = 0x0004A9A0;
inline constexpr std::uintptr_t scroll_up = 0x0004AA20;
inline constexpr std::uintptr_t scroll_down = 0x0004AA90;
inline constexpr std::uintptr_t resize_viewport_world = 0x0004ACF0;
inline constexpr std::uintptr_t world_input_dispatch = 0x0004CB80;
inline constexpr std::uintptr_t world_input_camera_set_call = 0x0004CC23;
inline constexpr std::uintptr_t focus_actor_camera = 0x0004CD60;
inline constexpr std::uintptr_t focus_actor_camera_set_call = 0x0004CD8B;
...
inline constexpr std::uintptr_t play_movie_thunk = 0x000011B8;
inline constexpr std::uintptr_t select_briefing_or_ending_asset = 0x00002BD0;
inline constexpr std::uintptr_t present_briefing_and_load_level = 0x000031C0;
inline constexpr std::uintptr_t help_presenter = 0x000045E0;
...
inline constexpr std::uintptr_t play_movie_blocking = 0x00007D80;
inline constexpr std::uintptr_t general_sound_request_thunk = 0x00001131;
inline constexpr std::uintptr_t guarded_general_sound_request = 0x000045A0;
inline constexpr std::uintptr_t alarm_sound_dispatch = 0x00008480;
inline constexpr std::uintptr_t alarm_sound_request_sequence = 0x000084B4;
inline constexpr std::uintptr_t resize_sound_buffers = 0x0000AFB0;
inline constexpr std::uintptr_t increment_sound_request_count = 0x0000B080;
inline constexpr std::uintptr_t load_sound_library = 0x0000B580;
inline constexpr std::uintptr_t queue_sound_request = 0x0000B800;
inline constexpr std::uintptr_t update_sound_requests = 0x0000B840;
inline constexpr std::uintptr_t play_sound_immediately = 0x0000B8A0;
inline constexpr std::uintptr_t start_sound_buffer = 0x0000C320;
inline constexpr std::uintptr_t sprite_group_sound_dispatcher = 0x0001D6F0;
inline constexpr std::uintptr_t update_movie_frame = 0x0001DAD0;
inline constexpr std::uintptr_t sprite_group_sound_request = 0x00027C80;
inline constexpr std::uintptr_t ui_button_update = 0x000485D0;
inline constexpr std::uintptr_t ui_button_sound_request_sequence = 0x000486C2;
inline constexpr std::uintptr_t ui_button_sound_request = 0x00048890;
inline constexpr std::uintptr_t actor_selected_voice_selector = 0x0005D610;
inline constexpr std::uintptr_t actor_acknowledge_voice_selector = 0x0005D7B0;
inline constexpr std::uintptr_t actor_voice_sound_request = 0x0005D780;
inline constexpr std::uintptr_t hostile_initial_voice_selector = 0x0005D900;
inline constexpr std::uintptr_t hostile_alert_voice_selector = 0x0005DA20;
inline constexpr std::uintptr_t hostile_followup_voice_selector = 0x0005DA60;
inline constexpr std::uintptr_t weather_particle_update = 0x0005FF20;
...
inline constexpr std::uintptr_t help_resource_name = 0x000CF704;
...
inline constexpr std::uintptr_t mission_7_document_recipient_update = 0x000596E0;
inline constexpr std::uintptr_t mission_7_document_carrier_update = 0x00059840;
...
inline constexpr std::uintptr_t attack_command_update = 0x00057B40;
inline constexpr std::uintptr_t animation_entered_last_frame = 0x0001D6A0;
...
inline constexpr std::uintptr_t tiedan_cover_update = 0x00059200;
...
inline constexpr std::uintptr_t break_tiedan_cover_after_pickup = 0x0005EC20;

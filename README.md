...
- 全部 12 个原版关卡和扩展关“余烬行动”“锄奸行动”“破晓密令”可直接选择，
  不改写原 EXE、不伪造存档；
- 15 关在点击原版“新游戏”后统一显示游戏进程内的文字任务简报和目标
  列表；修改 `Mod/关卡名称.json` 后下次任务立即生效，无需重新编译；
- 原 GFL 的十二张简报图片载荷已清除 5.209 MiB，同时保留全部 1,394 个
  固定资源索引；第 1、12 关已在精简归档上完成原引擎进图验证；
- “破晓密令”已消除跨全图巡逻造成的旧引擎路径重算瓶颈，并通过完整地图
  四角访问和 8—9% 单逻辑核占用回归；
...
本轮关卡性能与文字简报修复见
[`doc/扩展关卡与文字简报修复报告-20260727.md`](doc/扩展关卡与文字简报修复报告-20260727.md)。

![现代启动中心](Screenshots/ModernLauncher-final.png)

![游戏内文字任务简报](Screenshots/MissionBriefing-m013.png)

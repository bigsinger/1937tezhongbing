...
| 玩法 | A*、动态占位、实际战斗；四渲染队列；右侧五列背包；6/7/9 投射物；type 8/10 的 actor 62 精确伤害/几何/警报与 type 11 注意力保持；S 的 type 90/GFL 341 唯一观察标记与 B 的 type 78/GFL 64 藏尸/双容器/101 tick 闭环；实时右下角地图；十槽存档、按键重映射、分通道音量、失败重玩；原 WAV/简报与确定性事件回放 | actor 62 残留显示 tick、完整过场和长时间真实输入回放 |

...
|---|---:|---:|---:|---:|
| m000 | 0.758 | 99.08% | 1.117 | 0.9814 |
| m001 | 1.054 | 98.79% | 1.054 | 0.9734 |
| m002 | 0.998 | 98.54% | 1.460 | 0.9668 |
| m003 | 0.843 | 99.11% | 0.847 | 0.9819 |
| m004 | 1.084 | 98.78% | 1.676 | 0.9751 |
| m005 | 1.389 | 98.13% | 1.389 | 0.9735 |
| m006 | 0.907 | 98.88% | 0.991 | 0.9813 |
| m007 | 1.504 | 98.04% | 2.575 | 0.9416 |
| m008 | 0.916 | 98.54% | 1.197 | 0.9623 |
| m009 | 1.488 | 98.07% | 1.489 | 0.9645 |
| m010 | 0.908 | 98.79% | 1.540 | 0.9793 |
| m011 | 0.796 | 99.12% | 1.149 | 0.9828 |

现代基线共 48 个分块，零失败；全局最坏 MAE 为 2.575，最低近似像素率
96.20%，最低边缘相关度 0.9416，最高新增黑洞率 0.0567%。精简证据保存在
